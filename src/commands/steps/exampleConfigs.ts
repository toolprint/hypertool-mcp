...
export const EXAMPLE_CONFIGS: ExampleConfig[] = [
  {
    ...
    description:
      "Complete toolkit with 26 servers - works immediately without any API keys",
  ...
  },
  {
    ...
    description:
      "Full-featured setup with 52 servers - requires your API keys for business tools",
  ...
  },
  {
    ...
    description:
      "Essential development tools: Git, Docker, filesystem, SQLite, build tools",
  ...
  },
  {
    ...
    name: "Data Analysis",
    description:
      "Data processing tools: CSV, JSON, Excel, pandas, visualization",
  ...
  },
  {
    ...
    name: "Web Automation",
    description:
      "Browser automation, web scraping, API testing, and interaction tools",
  ...
  },
  {
    ...
    description:
      "Research tools: Hacker News, web search, scraping, content aggregation",
  ...
  },
  {
    ...
    description:
      "System tools: SSH, terminal, monitoring, configuration management",
  ...
  },
  {
    ...
    name: "Testing & QA",
    description:
      "Testing frameworks, browser automation, API testing, performance testing",
  ...
  },
  {
    ...
    description:
      "Time tracking, memory, note-taking, sequential thinking assistance",
  ...
  },
  {
    ...
    name: "Creative Media",
    description:
      "Image processing, video editing, audio tools, creative workflows",
  ...
  },
  {
    ...
    description:
      "Financial APIs, crypto tools, payment processing (requires API keys)",
...
export function getExampleDetails(exampleId: string): {
  ...
  const details: Record<
    string,
    { useCases: string[]; requirements: string[] }
  > = {
    everything: {
      useCases: [
    ...
    "data-analysis": {
      ...
      requirements: ["Python with pandas", "Node.js for CSV/JSON tools"],
    },
    "web-automation": {
      useCases: [
        "Web scraping",
      ...
      requirements: ["Chrome/Chromium installed", "Node.js environment"],
    },
    "content-research": {
      useCases: [
        "Content aggregation",
      ...
      requirements: ["Internet connection", "Node.js environment"],
    },
    "system-admin": {
      useCases: [
        "Server management",
    ...
    productivity: {
      ...
      requirements: ["Node.js environment", "Local storage access"],
    },
    "document-processing": {
      useCases: [
        "Document conversion",
      ...
      requirements: ["Pandoc installed", "PDF tools", "Node.js environment"],
    },
    "creative-media": {
      useCases: [
        "Image processing",
...
export async function verifyExamplesAvailable(): Promise<boolean> {
  try {
    ...
    logger.warn(
      "Example configurations not found. This may be a development environment issue."
    );
    return false;
  }
}
