  ...
  async run(state: WizardState): Promise<WizardState> {
    ...
    switch (installationType) {
      case "standard":
        ...
        output.info(
          theme.muted("   • Replace app configs to point to Hypertool")
        );
      ...
      case "development":
        ...
        output.info(
          theme.muted("   • Keep existing app configurations intact")
        );
        output.info(
          theme.muted("   • Create separate Hypertool configuration")
        );
