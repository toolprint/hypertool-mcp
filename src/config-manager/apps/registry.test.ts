...
describe('AppRegistry', () => {
  ...
  describe('initialization', () => {
    it('should create default registry on first load', async () => {
      ...
      expect(Object.keys(loadedRegistry.applications)).toContain('claude-desktop');
  ...
  describe('platform configuration', () => {
    ...
    it('should handle platform-specific configurations', async () => {
      ...
      if (app) {
        ...
        expect(darwinConfig?.configPath).toContain('Library/Application Support');
  ...
  describe('filesystem integration', () => {
    ...
    it('should work with actual file operations through memfs', async () => {
      ...
      expect(savedRegistry.applications['custom-app'].name).toBe('Custom Application');
    });
  });
});